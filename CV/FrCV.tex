...
\section{Éducation}
  ...
  \resumeSubheading
      ...
      {Maîtrise en informatique, temps partiel}{Début Sep 2025 -- Août 2027}
    \resumeSubheading
      {Université de Sherbrooke}{Québec, Canada}
...
\section{Expérience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Écrire des scripts \textbf{Python} pour automatiser les tâches et améliorer l'efficacité grâce à l'analyse de données.}
      \resumeItem{Technologies utilisées : \textbf{Python, Amazon SP-API, Suite Office, Fidelio ERP}.}
    \resumeItemListEnd

...
\section{Éducation}
  ...
  \resumeSubheading
      ...
      {Maîtrise en informatique, temps partiel}{Début Sep 2026 -- Août 2028}
    \resumeSubheading
      {Université de Sherbrooke}{Québec, Canada}
...
\section{Expérience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Responsable du Succès Client}{Oct 2025 -- Présent}
    {Institut du E-Commerce}{Hybride}
    \resumeItemListStart
      \resumeItem{Assurer le \textbf{succès} et l'accompagnement des étudiants en formation e-commerce.}
      \resumeItem{\textbf{Superviser} le parcours éducatif et fournir un \textbf{soutien personnalisé}.}
      \resumeItem{\textbf{Suivre} les progrès individuels et adapter les stratégies d'apprentissage.}
      \resumeItem{\textbf{Collaborer} avec l'équipe pédagogique pour améliorer la qualité des cours.}
      \resumeItem{Technologies utilisées : \textbf{Circle, Slack}.}
    \resumeItemListEnd
...
\section{Projets}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Vitopia – Simulations Visuelles d'Entités Informatiques et Biologiques} $|$ \emph{C++, OpenGL, Git}}{Projet de 260 heures}
          \resumeItemListStart
            \resumeItem{Développement d'une simulation 2D observant l'évolution d'organismes dans des sociétés complexes.}
            \resumeItem{\textbf{IA}, modélisation des comportements écologiques, des réactions aux stimuli et des interactions économiques.}
            \resumeItem{Le projet sera déployé en ligne et disponible sur \textbf{GitHub}.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{Coded Kingdom} $|$ \emph{Godot, Python, Aseprite, Git}}{Projet de 130 heures}
          \resumeItemListStart
            \resumeItem{Conception d'un jeu en \textbf{pixel art} qui enseigne la programmation à travers un gameplay interactif.}
            \resumeItem{Les joueurs doivent écrire du code et l'exécuter pour faire progresser leurs personnages dans les niveaux.}
            \resumeItem{C'était l'un de mes projets de fin de baccalauréat, avec tout le code et la dernière version disponibles sur \textbf{GitHub}.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{Budgetly} $|$ \emph{React, Tailwind CSS, Firebase}}{Outil Privé}
          \resumeItemListStart
            \resumeItem{Outil privé utilisant \textbf{React} et \textbf{Tailwind CSS} pour gérer mon budget personnel.}
            \resumeItem{Backend \textbf{Firebase} pour stockage sécurisé et synchronisation temps réel.}
            \resumeItem{Interface intuitive avec design moderne pour suivi et analyse budgétaire.}
            \resumeItem{Catégorisation des dépenses, objectifs budgétaires et rapports financiers.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{Taskline} $|$ \emph{React, SP-API, Firebase, Make.com}}{Outil Privé}
          \resumeItemListStart
            \resumeItem{Développement d'un outil utilisant \textbf{SP-API} pour exploiter les données de notre compte Amazon Seller Central.}
            \resumeItem{Implémentation de flux de traitement de données automatisés avec \textbf{Make.com} pour une intégration transparente.}
            \resumeItem{Création d'une interface \textbf{React} avec un backend \textbf{Firebase} pour fournir des analyses et des insights en temps réel.}
            \resumeItem{Rationalisation des opérations commerciales en centralisant les données du seller central et en améliorant les processus de prise de décision.}
          \resumeItemListEnd
          ...
          \resumeItemListStart
            ...
            \resumeItem{L'application permet de calculer les \textbf{doses d'insuline} nécessaires et est utilisée par des résidents pédiatriques pour vérifier leurs résultats de calcul à l'Hôpital Fleurimont, à Sherbrooke.}
            \resumeItem{Hébergée et déployée sur \textbf{Firebase}.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Compétences Techniques}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Outils de Développement}{: Git, Docker, Azure DevOps, Octopus, Datadog, CI/CD, Linux, Godot, Suite Office, Circle, Slack.} \\

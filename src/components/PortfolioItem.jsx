...
function PortfolioItem({ title, imgUrl, stack, link, isPrivate, description }) {
      ...
      <div className="card h-full overflow-hidden">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <div className="text-center p-4">
              {description ? (
                <p className="text-highlight text-sm leading-relaxed font-medium">
                  {description}
                </p>
              ) : (
        ...
        <div className="p-3 card-content">
          ...
          <div className="flex justify-between items-center card-actions">
            {isPrivate ? (
              <span className="btn-outline text-xs px-2 py-1.5">
            ...
            {/* External link icon - only show for non-private projects with valid links */}
            {isLinkValid && !isPrivate && (
